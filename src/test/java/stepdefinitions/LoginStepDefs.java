...
public class LoginStepDefs {
    ...
    public void kullaniciDogruEmailVeSifreyiExcelIleGirer() {
        ...
        String sheetName = "Sayfa1";  //sheet1 gibi de yazabilir dataexcel icinde
        ExcelUtil excelUtil = new ExcelUtil(path, sheetName);

        List<Map<String, String>> loginData = excelUtil.getDataList();

        loginPage.loginemailElement.sendKeys(loginData.get(0).get("Email"));  //git Email'in 0.indexini al
        loginPage.loginPasswordBox.sendKeys(loginData.get(0).get("Password"));  //git Password un 0.index'ini al
        //datalari sutun olarak aliyor
    ...
    public void kullaniciYanlisEmailVeSifreyiExcelIleGirer() {
        ...
        loginPage.loginemailElement.sendKeys(loginData.get(1).get("Email"));  //git Email'in 0.indexini al
    ...
    Assert.assertEquals(loginPage.incorrectYazisi.getText(),"Your email or password is incorrect!");
